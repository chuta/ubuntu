...
import { GovernmentDetail } from "@/components/crm/government-detail";
    ...
    <>
      ...
      <main className="flex-1 overflow-x-hidden overflow-y-auto p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] md:p-6">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <Link href="/governments" className="inline-flex items-center text-sm text-gray-500 hover:text-brand-purple">
          ...
          <div className="flex gap-2">
            ...
            <DeleteOrganizationButton id={id} name={organization.name} basePath="/governments" />
          </div>
        </div>

        <div className="space-y-6">
          <GovernmentDetail organization={organization} />
